...
Revision ID: cb465e9c654d
Revises: 
Create Date: 2025-08-29 06:25:39.493250
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['parent_run_id'], ['agent_runs.run_id'], name=op.f('fk_workflow_runs_parent_run_id_agent_runs')),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name=op.f('fk_workflow_runs_user_id_users')),
    sa.ForeignKeyConstraint(['workflow_id'], ['workflows.id'], name=op.f('fk_workflow_runs_workflow_id_workflows')),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_workflow_runs')),
    sa.UniqueConstraint('run_id', name=op.f('uq_workflow_runs_run_id'))
    )
    with op.batch_alter_table('workflow_runs', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_workflow_runs_parent_run_id'), ['parent_run_id'], unique=False)
    ...
    sa.ForeignKeyConstraint(['assigned_to_user_id'], ['users.id'], name=op.f('fk_human_tasks_assigned_to_user_id_users')),
    sa.ForeignKeyConstraint(['run_id'], ['workflow_runs.id'], name=op.f('fk_human_tasks_run_id_workflow_runs'), ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_human_tasks'))
    )
...
def downgrade() -> None:
    ...
    with op.batch_alter_table('workflow_runs', schema=None) as batch_op:
        ...
        batch_op.drop_index(batch_op.f('ix_workflow_runs_parent_run_id'))
