"""Add Fine Tune fine_tuned_model_id column to Conversation Metrics

Revision ID: ab28a67a0679
Revises: 7388d15f7764
Create Date: 2025-07-28 22:44:28.999457
...
revision: str = 'ab28a67a0679'
down_revision: Union[str, Sequence[str], None] = '7388d15f7764'
...
def upgrade() -> None:
    ...
    with op.batch_alter_table('conversation_metrics', schema=None) as batch_op:
        batch_op.add_column(sa.Column('fine_tuned_model_id', sa.String(length=255), nullable=True))
...
def downgrade() -> None:
    ...
    with op.batch_alter_table('conversation_metrics', schema=None) as batch_op:
        ...
        batch_op.drop_column('fine_tuned_model_id')
