"""Add parent_run_id to workflowrun tables

Revision ID: c6dd356d9a4c
Revises: eeead661fc0e
Create Date: 2025-08-03 20:44:33.238359
...
revision: str = 'c6dd356d9a4c'
down_revision: Union[str, Sequence[str], None] = 'eeead661fc0e'
...
def upgrade() -> None:
    ...
    with op.batch_alter_table('workflow_runs', schema=None) as batch_op:
        ...
        batch_op.create_foreign_key(batch_op.f('fk_workflow_runs_parent_run_id_agent_runs'), 'agent_runs', ['parent_run_id'], ['run_id'])
...
def downgrade() -> None:
    ...
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table('workflow_runs', schema=None) as batch_op:
        batch_op.drop_constraint(batch_op.f('fk_workflow_runs_parent_run_id_agent_runs'), type_='foreignkey')
