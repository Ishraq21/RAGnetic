"""Add embedding_cost_usd to conversation_metrics

Revision ID: 251eec9b6e10
Revises: 22af019ebf9b
Create Date: 2025-07-27 23:10:14.342641
...
revision: str = '251eec9b6e10'
down_revision: Union[str, Sequence[str], None] = '22af019ebf9b'
...
def upgrade() -> None:
    ...
    with op.batch_alter_table('conversation_metrics', schema=None) as batch_op:
        batch_op.add_column(sa.Column('embedding_cost_usd', sa.Float(precision=10), nullable=True))
...
def downgrade() -> None:
    ...
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table('conversation_metrics', schema=None) as batch_op:
        batch_op.drop_column('embedding_cost_usd')
