"""Add agent state machine with status and cost tracking

Revision ID: d8d23bea56fd
Revises: 82fa27ad6469
Create Date: 2025-09-15 19:57:30.994717
...
revision: str = 'd8d23bea56fd'
down_revision: Union[str, Sequence[str], None] = '82fa27ad6469'
...
def upgrade() -> None:
    ...
    with op.batch_alter_table('agents', schema=None) as batch_op:
        batch_op.add_column(sa.Column('status', sa.Enum('created', 'configured', 'deploying', 'deployed', 'idle', 'error', 'stopped', name='agent_deployment_status_enum'), nullable=False))
        batch_op.add_column(sa.Column('last_updated', sa.DateTime(), nullable=False))
        batch_op.add_column(sa.Column('total_cost', sa.Float(precision=10), nullable=False))
        batch_op.add_column(sa.Column('gpu_instance_id', sa.String(length=255), nullable=True))
...
def downgrade() -> None:
    ...
    with op.batch_alter_table('agents', schema=None) as batch_op:
        ...
        batch_op.drop_column('gpu_instance_id')
