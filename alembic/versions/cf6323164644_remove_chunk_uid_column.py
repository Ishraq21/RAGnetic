"""Remove Chunk UID Column

Revision ID: cf6323164644
Revises: f3072fc79ddb
Create Date: 2025-08-02 03:25:00.204387
...
revision: str = 'cf6323164644'
down_revision: Union[str, Sequence[str], None] = 'f3072fc79ddb'
...
def downgrade() -> None:
    ...
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table('document_chunks', schema=None) as batch_op:
        batch_op.add_column(sa.Column('chunk_uid', sa.VARCHAR(length=255), nullable=True))
        batch_op.create_index(batch_op.f('ix_document_chunks_chunk_uid'), ['chunk_uid'], unique=1)
