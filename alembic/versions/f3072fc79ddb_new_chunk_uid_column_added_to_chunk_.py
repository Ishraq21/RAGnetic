"""New Chunk UID Column Added to Chunk Table

Revision ID: f3072fc79ddb
Revises: 48b4a5bb97ff
Create Date: 2025-08-02 03:08:11.024221
...
revision: str = 'f3072fc79ddb'
down_revision: Union[str, Sequence[str], None] = '48b4a5bb97ff'
...
def upgrade() -> None:
   ...
   # op.drop_table('celery_solarschedule')
    with op.batch_alter_table('document_chunks', schema=None) as batch_op:
        batch_op.add_column(sa.Column('chunk_uid', sa.String(length=255), nullable=True))
        batch_op.create_index(batch_op.f('ix_document_chunks_chunk_uid'), ['chunk_uid'], unique=True)
...
def downgrade() -> None:
    ...
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table('document_chunks', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_document_chunks_chunk_uid'))
        batch_op.drop_column('chunk_uid')
